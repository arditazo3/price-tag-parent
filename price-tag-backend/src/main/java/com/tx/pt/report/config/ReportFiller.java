...
public class ReportFiller {
    ...
    public void createDataSource(ReportData reportData) {
        ...
        if (!isEmpty(reportData.getCommercialActivities())) {
            ...
            Integer tipologyPrice = reportData.getFormatSettings().getTipologyPrice();
            Integer numberCols = reportData.getFormatSettings().getNumberCols();

            if ((tipologyPrice.compareTo(new Integer(1)) == 0 ||
                    tipologyPrice.compareTo(new Integer(2)) == 0 &&
                            numberCols.compareTo(new Integer(2)) == 0) &&
            ...
            } else if (tipologyPrice.compareTo(new Integer(2)) == 0 &&
